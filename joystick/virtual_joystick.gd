...
## The color of the button when the joystick is pressed.s
@export var pressed_color := Color.GRAY

## If the input is inside this range, the output is zero.
@export_range(0, 200, 1) var deadzone_size : float = 10*.3

## The max distance the tip can reach
@export_range(0, 500, 1) var clampzone_size : float = 75*.3
...
@onready var center : Vector2 =Vector2.ZERO
